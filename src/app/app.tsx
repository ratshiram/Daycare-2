...
const App = () => {
    ...
    // Generic fetchData function, now defined outside useCallback for use in useEffect
    const fetchData = async (dataType: string, setDataCallback: Function, query: Promise<any>) => {
